...
class AnalogToDigitalWindow(ctk.CTk):
    ...
    def create_random_form(self):
        ...
        ctk.CTkButton(self.random_form_frame, text="Analog to Digital Conversion", command=lambda: self.analog_to_digital_conversion(
    ...
    def create_import_form(self):
        ...
        ctk.CTkButton(self.import_form_frame, text="Analog to Digital Conversion", command=lambda: self.analog_to_digital_conversion(
            self.analog_signal, self.import_plot_frame)).pack(pady=10)
    ...
    def analog_to_digital_conversion(self, analog_signal, plot_frame):
        ...
        ) or self.import_bit_depth_label.get()
